...
#以下参数代表服务器配置信息有多少机器配置多少个,这里的配置用于取值
#远程服务器路径
remote_server_paths=("/home/product/installed/apache-tomcat-8.5.9")
#远程服务器用户
remote_users=("product")
#远程服务器ip
remote_ips=("120.25.251.5")
#远程服务器端口
remote_ports=("22")
#远程服务器密码 可以不设置
remote_pwds=("Hjx574311651$")
#maven打包用的远程profiles
remote_profiles=("prod")
#远程server_flags
remote_server_flags=(5)
#本地profile
local_profile="local"
#本地tomcat webapps目录
local_server_path="/Users/houjinxin/Documents/apache-tomcat-8.5.9"
#项目远程build路径
remote_project_basepath="/Users/houjinxin/Documents"
#maven本地路径
maven_home=""
#项目本地路径
local_project_basepath="/Users/houjinxin/Documents"
#项目名称
project_name="maiev"
#war包所在的maven子模块,只支持一个war包的工程 为空时代表在父及目录下的target中存在war包
...
remote_shell_dir="/home/product"
#项目git地址
repository_url="https://git.oschina.net/yangsj/maiev.git"
#父工程路径
parent_project_path="$local_project_basepath/$project_name"
#子工程路径
sub_project_path="$parent_project_path/$war_sub_project_name"
...
war_path="$sub_project_path/target/$war_name"
#本地tocmat进程唯一筛选条件，本地多实例部署时根据这一个条件杀死指定进程
local_tomcat_process_name="apache-tomcat-8.5.9"
